...
![The Moritsuke icon in the activity bar](images/getting-started-01-activity-bar.png)
...
![The Projects list and the Moritsuke tab, before any project exists](images/getting-started-02-welcome.png)
...
![Step 1: name the website](images/getting-started-03-name.png)
...
![Step 3: choose where to save it](images/getting-started-05-location.png)

Your website opens in the editor:

![A new website made from the Portfolio template](images/getting-started-06-editor.png)
...
![The Get started walkthrough](images/getting-started-07-walkthrough.png)
